        ...
        return (
            <div>
                ...
                <PageFooter isDarkColorSelected={isDarkBackground} title={'change background :'}>
                    <ColorList colors={backgroundColors} selectedColor={background} isDarkColorSelected={isDarkBackground} onColorChange={this.handleOnChangeBackground} onTogglePicker={this.handleTogglePicker} pickerStatus={this.state.picker.enabled} />
                </PageFooter>
            </div>
        );
    }
...
const Title = ({ isDarkBackground }) => {
    return (
        <div className="title" style={isDarkBackground ? { color: Color('#444').negate() } : {}}>
            <h1>Box Shadows</h1>
            <p className="subtitle" style={isDarkBackground ? { color: Color('#777').negate() } : {}}>
